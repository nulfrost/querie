...
var validateQuestion = ({
  ...
  if (!title || title.trim().length > 50) {
    errors.title = "Please enter a valid title, length must not exceed 50 characters";
  }
  if (!description || description.trim().length > 5e3) {
    errors.description = "Please enter a valid description, length must not exceed 5000 characters";
  }
  if (!category) {
...
var action2 = async ({ request }) => {
  ...
  if (Object.values(errors).filter(Boolean).length > 0) {
    return (0, import_node3.json)(errors, { status: 422 });
  }
...
function New() {
  ...
  const submit = (0, import_react6.useSubmit)();
  const schema = import_zod.z.object({
    title: import_zod.z.string().min(10, { message: "Title must be at least 10 characters long" }).max(100, { message: "Title must not exceed 100 characters" }),
    description: import_zod.z.string().min(100, { message: "Description must be at least 100 characters" }).max(5e3, { message: "Description must not exceed 5000 characters" })
  });
  const form = (0, import_form.useForm)({
    ...
    schema: (0, import_form.zodResolver)(schema)
  });
  const titleRef = (0, import_react7.useRef)(null);
  console.log(actionData);
  (0, import_react7.useEffect)(() => {
    var _a2;
    (_a2 = titleRef == null ? void 0 : titleRef.current) == null ? void 0 : _a2.focus();
  }, []);
  return /* @__PURE__ */ React.createElement(import_core4.Box, {
    ...
    component: "form",
    onSubmit: form.onSubmit((values) => submit({
      title: values.title,
  ...
  }, /* @__PURE__ */ React.createElement(import_core4.TextInput, __spreadProps(__spreadValues({
    label: "Title",
    name: "title",
    id: "title"
  }, form.getInputProps("title")), {
    error: form.errors.title || (actionData == null ? void 0 : actionData.title),
    required: true,
    ref: titleRef,
    maxLength: 50,
    mb: "sm"
  })), /* @__PURE__ */ React.createElement(import_core4.Textarea, __spreadProps(__spreadValues({
    label: "Description",
    name: "description",
    error: ((_a = form == null ? void 0 : form.errors) == null ? void 0 : _a.description) || (actionData == null ? void 0 : actionData.description)
    ...
    maxLength: 5e3,
    mb: "sm"
  })), /* @__PURE__ */ React.createElement(import_core4.NativeSelect, __spreadProps(__spreadValues({}, form.getInputProps("category")), {
    data: categoryNames,
    label: "Category",
    name: "category",
...
function QuestionCard({
  ...
  return /* @__PURE__ */ React.createElement(import_core11.Card, {
    ...
    color: "red",
    ml: "auto",
    onClick: () => isAuthenticated ? submit({ userId: author.id, questionId: id }, { replace: true, method: "post", action: "/like" }) : navigate("/login")
...
var loader7 = async ({ request }) => {
  try {
    ...
    return (0, import_node5.json)({ user, questions });
  } catch (e) {
    console.error(e);
  }
};
function Index() {
  ...
  const { user, questions } = (0, import_react13.useLoaderData)();
...
// route:/Users/dane/Desktop/github/react/querie/app/routes/like.tsx
var like_exports = {};
